...
const ProductDetails = () => {
  ...
  const offers = [
    { quantity: 2, price: 800, discount: "11%" },
    { quantity: 3, price: 1050, discount: "22%" },
  ];
  ...
  const product = {
    ...
    price: 499,
    description:
      "ترنج لاكوست الجديد بتصميمة الفريد وألوانة الأساسية متوفر الان بأعلي الخامات وافضل الاسعار فقط في XENO ",
    images: [a1, a2, a3],
